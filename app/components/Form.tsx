    ...
    return (
        <div>
            <input 
                ...
                className='font-sans w-[300px] sm:w-[400px]  p-2 m-3 mt-8 rounded border border-gray-300 bg-light invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer'
                required 
